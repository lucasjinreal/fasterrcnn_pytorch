...
checkpoint_path = os.path.join('./checkpoints', 'faster_rcnn_vgg16_snakes.pth')
...
def parse_args():
    ...
    parser.add_argument('--cpu', dest='cpu',
                        help='force using cpu, default using cuda',
                        action='store_true')
...
if __name__ == '__main__':
    ...
    if args.dataset == "pascal_voc":
        ...
        args.imdbval_name = "voc_0712_val"
        args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]',
                         'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
    elif args.dataset == "pascal_voc_like":
        args.imdb_name = "voc_like_train"
        args.imdbval_name = "voc_like_val"
        args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]',
                     'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
    elif args.dataset == "snakes":
        args.imdb_name = "snakes_train"
        args.imdbval_name = "snakes_val"
        args.set_cfgs = ['ANCHOR_SCALES', '[8, 16, 32]',
                         'ANCHOR_RATIOS', '[0.5,1,2]', 'MAX_NUM_GT_BOXES', '20']
    ...
    # TODO: change your down data path here
    cfg.DATA_DIR = '/media/jintain/wd/ai/innovations/mask_yolov3/data/Snakes'
    ...
    if not torch.cuda.is_available():
        logger.warning('you do not have a GPU, using --cpu instead')
    ...
    cfg.CUDA = torch.cuda.is_available() and not args.cpu
        ...
        for epoch in range(args.start_epoch, args.max_epochs + 1):
            ...
            for step in range(iters_per_epoch):
                ...
                if step % args.disp_interval == 0:
                    ...
                    if args.mGPUs:
                        ...
                        bg_cnt = rois_label.data.numel() - fg_cnt
                    logger.info(
                        'Epoch: {}, iter: {}, loss: {}, fg/bg: {}, rpn_cls: {}, rpn_box: {}, rcnn_cls: {}, rcnn_box: {}'.format(
                            epoch, step, loss_temp, fg_cnt, loss_rpn_cls, loss_rpn_box, loss_rcnn_cls, loss_rcnn_box
                        ))
                    if args.use_tfboard:
                        info = {
                            'loss': loss_temp,
            ...
            if epoch % 10 == 0 and epoch != 0:
                save_checkpoint({
                    ...
                    'epoch': epoch + 1,
                    'state_dict': fasterRCNN.module.state_dict() if args.mGPUs else fasterRCNN.state_dict(),
                    'optimizer': optimizer.state_dict(),
                    'pooling_mode': cfg.POOLING_MODE,
                    'class_agnostic': args.class_agnostic,
                }, checkpoint_path)
                logger.info('save model: {}'.format(checkpoint_path))
