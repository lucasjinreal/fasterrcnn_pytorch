...
from lib.model.utils.net_utils import save_net, load_net
...
net = 'vgg16'
# for VOC
all_classes = np.asarray(['__background__', '波士顿蛋糕', '南枣核桃糖',
...
checkpoint_path = os.path.join(
    './checkpoints', 'faster_rcnn_vgg16_snakes_like_release.pth')
img_dir = './images/snakes'
...
def vis_detections(im, class_name, dets, thresh=0.8, cv_chinese=False):
        ...
        for j in range(1, num_classes):
            ...
            if inds.numel() > 0:
                ...
                im_in = vis_detections(
                    im_in, all_classes[j], cls_dets.cpu().numpy(), 0.5, cv_chinese)
