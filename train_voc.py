...
checkpoint_path = os.path.join('./checkpoints', 'faster_rcnn_vgg16_voc_like.pth')
...
def parse_args():
    ...
    parser.add_argument('--dataset', dest='dataset',
                        ...
                        default='pascal_voc_like', type=str)
            ...
            for step in range(iters_per_epoch):
                ...
                if step % args.disp_interval == 0:
                    ...
                    if args.mGPUs:
                        ...
                        fg_cnt = torch.sum(rois_label.data.ne(0))
                        bg_cnt = rois_label.data.numel() - fg_cnt
                    logger.info('Epoch: {}, iter: {}, loss: {}, fg/bg: {}, rpn_cls: {}, rpn_box: {}, rcnn_cls: {}, rcnn_box: {}'.format(
